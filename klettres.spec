...
Source0  : https://download.kde.org/stable/release-service/22.04.1/src/klettres-22.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.1/src/klettres-22.04.1.tar.xz.sig
...
%prep
%setup -q -n klettres-22.04.1
cd %{_builddir}/klettres-22.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652648037
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/klettres-22.04.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/klettres/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/klettres-22.04.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/klettres/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/klettres-22.04.1/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/klettres/a4c60b3fefda228cd7439d3565df043192fef137
pushd clr-build
%make_install
popd
%find_lang klettres
