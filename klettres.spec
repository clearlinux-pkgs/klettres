...
Source0  : https://download.kde.org/stable/release-service/20.12.3/src/klettres-20.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.3/src/klettres-20.12.3.tar.xz.sig
...
%prep
%setup -q -n klettres-20.12.3
cd %{_builddir}/klettres-20.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618682088
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/klettres-20.12.3/COPYING %{buildroot}/usr/share/package-licenses/klettres/d357e60aa8efd63b4475c3363700ba54f9a71343
cp %{_builddir}/klettres-20.12.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/klettres/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/klettres-20.12.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/klettres/c08668a6ace9b36ba46940609040748161b03a37
pushd clr-build
%make_install
popd
%find_lang klettres
