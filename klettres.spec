...
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/klettres-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/klettres-25.04.2.tar.xz.sig
...
%setup -q -n klettres-25.04.2
cd %{_builddir}/klettres-25.04.2
pushd ..
cp -a klettres-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749508117
mkdir -p clr-build
pushd clr-build
