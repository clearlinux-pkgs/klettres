...
Version  : 21.12.0
Release  : 35
URL      : https://download.kde.org/stable/release-service/21.12.0/src/klettres-21.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/klettres-21.12.0.tar.xz
...
%prep
%setup -q -n klettres-21.12.0
cd %{_builddir}/klettres-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639625861
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/klettres-21.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/klettres/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/klettres-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/klettres/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/klettres-21.12.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/klettres/a4c60b3fefda228cd7439d3565df043192fef137
pushd clr-build
%make_install
popd
%find_lang klettres
